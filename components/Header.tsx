    ...
    <header className="h-16 bg-white border-b border-slate-200 sticky top-0 z-10 flex items-center justify-between px-4 lg:px-8 shadow-sm">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 top-full mt-1 w-32 bg-white rounded-lg shadow-xl border border-slate-100 py-1 hidden group-hover:block animate-slide-in-bottom origin-top-right">
            <button
